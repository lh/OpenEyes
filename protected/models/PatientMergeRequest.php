...
class PatientMergeRequest extends BaseActiveRecordVersioned
{
    ...
    public function attributeLabels()
    {
        return array(
                    'id' => 'ID',
                    'primary_id' => 'Primary',
                    'primary_hos_num' => 'Primary ' . Yii::app()->params['hos_label_short'] . ' Num',
                    'primary_nhsnum' => 'Primary ' . Yii::app()->params['nhs_label'] . ' num',
                    'primary_dob' => 'Primary Dob',
                    'primary_gender' => 'Primary Gender',
                    'secondary_id' => 'Secondary',
                    'secondary_hos_num' => 'secondary ' . Yii::app()->params['hos_label_short'] . ' Num',
                    'secondary_nhsnum' => 'secondary ' . Yii::app()->params['nhs_label'] . ' num',
