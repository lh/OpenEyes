...
class ElementLetter extends BaseEventTypeElement
{
    ...
    public function calculateRe($patient)
    {
        ...
        return $re . ', DOB: ' . $patient->NHSDate('dob') . ', Hosp No: ' . $patient->hos_num . ', ' . Yii::app()->params['nhs_label'] . ' No: ' . $patient->nhsnum;
    }
    ...
    public function setDefaultOptions(Patient $patient = null)
    {
        if (Yii::app()->getController()->getAction()->id == 'create') {
            ...
            $this->re .= ', DOB: ' . $patient->NHSDate('dob') . ', Hosp No: ' . $patient->hos_num . ', ' . Yii::app()->params['nhs_label'] . ' No: ' . $patient->nhsnum;
