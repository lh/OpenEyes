...
<?php } else {?><?php echo Yii::app()->params['hos_label_short'] ?> No: <?php echo $element->event->episode->patient->hos_num?>, <?php echo Yii::app()->params['nhs_label']?> No: <?php echo $element->event->episode->patient->nhsnum?> <?php }?></strong></p>
