...
class PracticeController extends BaseController
{
    ...
    public function accessRules()
    {
        return array(
            array(
                'allow',  // allow users with either the TaskViewPractice or TaskCreatePractice roles to view Practice data
                'actions' => array('index', 'view'),
                'roles' => array('TaskViewPractice', 'TaskCreatePractice')
            ),
            array(
                'allow', // allow users with either the TaskCreatePractice or TaskAddPatient roles to perform 'create' actions
    ...
    public function actionCreate($context=null)
    {
        ...
        if (isset($_POST['Contact'])) {
            ...
            list($contact, $practice, $address) = $this->performPracticeSave($contact, $practice, $address, $context === 'AJAX');
        }
        if ($context === 'AJAX') {
            ...
            $this->render('create', array(
                'model' => $practice,'address' => $address, 'contact' => $contact,
            ));
        }
    }
...
public function actionUpdate($id)
{
    ...
    $this->render('update', array(
        'model' => $model, 'address' => $address, 'contact' => $contact,
    ));
}
